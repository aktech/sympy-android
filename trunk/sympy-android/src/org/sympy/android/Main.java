...
public class Main extends Activity implements OnTouchListener, OnClickListener,
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		try {
			...
			final String sympyGammaUrl = this.getResources().getString(
					R.string.sympygammaurl);
			final String sympyGammaProcessUrl = this.getResources().getString(
					R.string.sympygammaprocessurl);
			...
			wv.loadUrl(sympyGammaUrl);

			btn.setOnClickListener(new OnClickListener() {
				public void onClick(View v) {

					wv.loadUrl(sympyGammaProcessUrl
							+ URLEncoder.encode(mEt.getText().toString()));
				}
			});
